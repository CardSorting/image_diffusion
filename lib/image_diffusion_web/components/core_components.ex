defmodule ImageDiffusionWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ImageDiffusionWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ImageDiffusionWeb.Gettext, "errors", msg, opts)
    end
  end
